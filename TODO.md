...
> **Note**: WEP cracking functionality is planned but not currently implemented in wifitex. While aircrack-ng supports WEP cracking, wifitex focuses on modern wireless security testing (WPA/WPA2/WPS/PMKID).
