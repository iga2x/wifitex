...
class CrackResult(object):
    ...
    def __init__(self):
        # Ensure commonly referenced attributes exist for static type checking.
        self.essid = getattr(self, 'essid', None)
        self.bssid = getattr(self, 'bssid', None)
        self.result_type = getattr(self, 'result_type', '')
